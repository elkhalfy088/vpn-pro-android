 ...
 */
export const getServers = async ( options?: Parameters<typeof customFetch>[1]): Promise<Server[]> => {
 ...
 */
export const createServer = async (serverInput: ServerInput, options?: Parameters<typeof customFetch>[1]): Promise<Server> => {
 ...
 */
export const getServer = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Server> => {
...
export const updateServer = async (id: number,
    serverUpdate: ServerUpdate, options?: Parameters<typeof customFetch>[1]): Promise<Server> => {
...
export const getActivateServerUrl = (id: number,) => {
 ...
 */
export const activateServer = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Server> => {

  return customFetch<Server>(getActivateServerUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getActivateServerMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof activateServer>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof activateServer>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof activateServer>>, {id: number}> = (props) => {
          const {id} = props ?? {};
